...
{$ENDIF}
 ...
 TRegExpr = class
   ...
   public
    ...
    // If true, then ÅEˇ  additional include russian letter '∏',
    // ¿-ﬂ  additional include '®', and ÅEﬂ include all russian symbols.
...
//  i : int64;
 begin
  ...
  if val < scan
   ...
   // "P ÅEQ computes the difference between the address given
...
{$IFDEF UniCode}
 ...
 RusRangeLoLow = #$430{'ÅE};
 RusRangeLoHigh = #$44F{'ˇ'};
 RusRangeHiLow = #$410{'¿'};
 RusRangeHiHigh = #$42F{'ﬂ'};
{$ELSE}
 RusRangeLo = '‡·‚„‰Â∏ÊÁËÈÅEÅE˙@ÒÚÛÙıˆ˜¯˘˙˚ÅE˛ˇ';
 RusRangeHi = '¿¡¬√ƒ≈®∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄€‹›ﬁﬂ';
 RusRangeLoLow = 'ÅE;
 RusRangeLoHigh = 'ˇ';
 RusRangeHiLow = '¿';
 RusRangeHiHigh = 'ﬂ';
...
procedure TRegExpr.SetInputString (const AInputString : RegExprString);
 ...
 begin
  ...
  !! startp/endp ‚ÒÅE‡‚ÌÅE·Û‰ÂÅE˙@‡Ò˚M ËÒÅEÅEÁÓ‚‡Ú¸ ?
  }
